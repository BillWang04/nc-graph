      ...
      <div className="container mx-auto px-6 flex justify-between items-center">
        <div className="flex items-center space-x-2">
          <svg viewBox="0 0 24 24" className="w-8 h-8 text-primary" fill="currentColor">
            ...
            {/* <!-- Surrounding nodes with varying sizes --> */}
            ...
            {/* <!-- Connecting lines --> */}
            <line x1="12" y1="12" x2="6" y2="6" stroke="currentColor" stroke-width="1.2"/>
            <line x1="12" y1="12" x2="18" y2="6" stroke="currentColor" stroke-width="1.2"/>
            <line x1="12" y1="12" x2="5" y2="16" stroke="currentColor" stroke-width="1.2"/>
            <line x1="12" y1="12" x2="12" y2="19" stroke="currentColor" stroke-width="1.2"/>
            <line x1="12" y1="12" x2="19" y2="16" stroke="currentColor" stroke-width="1.2"/>
          </svg>
